...
export const TIGER_FILLED_ORDERS_SCREENSHOT_OCR: OcrImageResult = image(
  "tiger-filled-orders",
  753,
  13_574,
  [
    ocrLine("订单", 28, 120, 60, 28),
    ocrLine("状态", 28, 220, 42, 22),
    ocrLine("已成交", 96, 220, 68, 22),
    ocrLine("类型", 28, 280, 42, 22),
    ocrLine("股票", 96, 280, 48, 22),
    ocrLine("代码｜名称", 28, 370, 145, 22),
    ocrLine("方向", 245, 370, 48, 22),
    ocrLine("总量｜价格", 355, 370, 120, 22),
    ocrLine("成交时间", 585, 370, 120, 22),
    ocrLine("Corteva, Inc.", 28, 470, 170, 24),
    ocrLine("US CTVA", 28, 505, 100, 22),
    ocrLine("卖出", 245, 470, 48, 24),
    ocrLine("100", 355, 470, 64, 24),
    ocrLine("88.76", 355, 505, 74, 22),
    ocrLine("2026/07/29", 585, 470, 120, 22),
    ocrLine("23:01:17", 585, 505, 100, 22),
    ocrLine("招商证券", 28, 700, 170, 24),
    ocrLine("HK 06228", 28, 735, 100, 22),
    ocrLine("卖出", 245, 700, 48, 24),
    ocrLine("200", 355, 700, 64, 24),
    ocrLine("26.380", 355, 735, 74, 22),
    ocrLine("2026/06/26", 585, 700, 120, 22),
    ocrLine("10:22:37", 585, 735, 100, 22),
  ],
);
