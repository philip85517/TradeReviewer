...
export function EpisodeNotesPanel({ episodeId, instrumentId, record, knowledgeCursor, episodeStartedAt, delayMs, replayComplete = false, onSave }: Props) {
  ...
  return (
    <section className="episode-notes-panel" aria-label="当前回合复盘">
      <div className="episode-review-sections" key={episodeId}>
        <details className="notes-stage" open={!replayComplete}><summary>事前计划</summary><fieldset><legend className="sr-only">事前计划</legend>
        ...
        <details className="notes-stage" open={replayComplete}><summary>事后总结</summary><fieldset><legend className="sr-only">事后复盘</legend>
