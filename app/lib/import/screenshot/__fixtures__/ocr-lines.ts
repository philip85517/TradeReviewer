...
export const TIGER_FILLED_ORDERS_SCREENSHOT_OCR: OcrImageResult = image(
  ...
  [
    ...
    ocrLine("方向", 382, 370, 48, 22),
    ocrLine("总量|价格", 467, 370, 120, 22),
    ocrLine("成交时间", 633, 370, 95, 22),
    ocrLine("Corteva, Inc.", 28, 470, 170, 24),
    ocrLine("US CTVA", 28, 505, 100, 22),
    ocrLine("卖出", 376, 470, 58, 24),
    ocrLine("100", 535, 470, 52, 24),
    ocrLine("88.76", 525, 505, 62, 22),
    ocrLine("2026/07/29", 598, 470, 136, 22),
    ocrLine("23:01:17", 640, 505, 94, 22),
    ocrLine("招商证券", 28, 700, 170, 24),
    ocrLine("HK 06228", 28, 735, 100, 22),
    ocrLine("卖出", 376, 700, 58, 24),
    ocrLine("200", 535, 700, 52, 24),
    ocrLine("26.380", 512, 735, 75, 22),
    ocrLine("2026/06/26", 598, 700, 136, 22),
    ocrLine("10:22:37", 642, 735, 92, 22),
  ],
);
